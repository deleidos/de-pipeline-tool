 ...
 */
public abstract class AbstractMapping implements Initializable {

	private static final Logger log = Logger.getLogger(AbstractMapping.class);
	...
	class TranslationAction {
		...
		TranslationAction(String key, String path, String directive) {
			...
			if (this.dataType == null) {
				...
				this.parameters[0] = AbstractMapping.convertString(dataType, format, value);
